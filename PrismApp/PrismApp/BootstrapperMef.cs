...
namespace PrismApp
{
    public class BootstrapperMef : MefBootstrapper
    {
        protected override DependencyObject CreateShell()
        {
            var shell = Container.GetExportedValue<MefShell>("MefShell");
            return shell;
        }
        ...
        protected override void ConfigureAggregateCatalog()
        {
            ...
            var asyCatalog = new AssemblyCatalog(typeof(BootstrapperMef).Assembly);
